...
export function HospicalfaPlatform() {
  ...
  return (
    <div style={{ fontFamily:"var(--font-outfit),system-ui,sans-serif", minHeight:"100vh", background:C.bg }}>
      ...
      <Navbar page={page} cart={cart} onNav={go} onAdmin={goAdmin} />
      ...
      {/* ABOUT */}
      {page === "about" && (
        <div style={{ padding:"80px 60px", background:C.bg, minHeight:"70vh" }}>
          <div style={{ maxWidth:900, margin:"0 auto" }}>
            <div style={{ textAlign:"center", marginBottom:60 }}>
              <div style={{ fontSize:72, marginBottom:20 }}>🏥</div>
              <h1 style={{ fontSize:42, fontWeight:800, color:C.navy, marginBottom:16 }}>
                Sobre Hospicalfa Medical
              </h1>
              <p style={{ color:C.muted, fontSize:17, lineHeight:1.75, maxWidth:600, margin:"0 auto" }}>
                Empresa dominicana especializada en distribución y venta de insumos y
                equipamiento médico certificado desde 2010, con presencia en todas las
                provincias del país.
              </p>
            </div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:20, marginBottom:40 }}>
              {[
                { t:"Nuestra Misión",  d:"Proveer insumos y equipamiento médico de alta calidad a todas las instituciones de salud de la República Dominicana, garantizando productos certificados a precios competitivos.", i:"🎯" },
                { t:"Nuestra Visión",  d:"Ser la empresa líder en distribución de insumos médicos en el Caribe, reconocida por su excelencia en servicio, calidad de productos y compromiso con la salud de los dominicanos.", i:"🌟" },
                { t:"Nuestros Valores",d:"Integridad, calidad, compromiso y servicio al cliente. Operamos con transparencia y nos guiamos por los más altos estándares éticos del sector salud.", i:"⚖️" },
                { t:"Nuestra Historia",d:"Fundada en 2010 en Santiago de los Caballeros, hemos crecido de una pequeña distribuidora local a una empresa con cobertura nacional y más de 500 clientes activos.", i:"📖" },
              ].map((item, i) => (
                <div key={i} style={{
                  ...
                  <p style={{ color:C.muted, fontSize:14, lineHeight:1.7 }}>{item.d}</p>
                </div>
              ))}
            </div>
            ...
            <div style={{
              ...
              display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:24, color:"#fff",
            }}>
              {[
        ...
        <div style={{ padding:"60px 60px", background:C.bg, minHeight:"70vh" }}>
          <div style={{ maxWidth:900, margin:"0 auto" }}>
            <div style={{ textAlign:"center", marginBottom:48 }}>
              ...
              <h1 style={{ fontSize:42, fontWeight:800, color:C.navy, marginBottom:12 }}>Contáctenos</h1>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:32 }}>
              {/* CONTACT INFO */}
              <div>
                <h2 style={{ fontSize:22, fontWeight:700, color:C.navy, marginBottom:24 }}>Información de Contacto</h2>
                {[
                  ...
                  <div key={i} style={{ display:"flex", gap:16, marginBottom:24 }}>
                    <div style={{
                      width:44, height:44, borderRadius:12, background:C.tealLt,
                ...
                <div style={{ marginTop:8 }}>
                  <div style={{ fontSize:13, color:C.muted, marginBottom:12, fontWeight:600 }}>HORARIO DE ATENCIÓN</div>
                  <div style={{ fontSize:14, color:C.txt, lineHeight:1.9 }}>
